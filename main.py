...
class Actor:
    def __init__(self, xpos = 0, ypos = 0):
        ...
        self.image = None
        self.body = pygame.Rect(self.pos.x, self.pos.y, DEFAULTRECTSIZE, DEFAULTRECTSIZE)
        self.head = pygame.Rect(self.pos.x+DEFAULTRECTSIZE, self.pos.y, DEFAULTRECTSIZE/2, DEFAULTRECTSIZE/2)
...
class Surface:
    def __init__(self, xpos, ypos, width, height):
        ...
        self.width = width
        self.height = height
        self.body = pygame.Rect(self.pos.x, self.pos.y, self.width, self.height)
